package com.example.notification10
...
import com.example.notification10.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun notifyBuilder():Notification{
        ...
        val clickPendingIntent = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            PendingIntent.getService(this, 0, clickIntent, FLAG_NO_CREATE)
        }
